...
- `src/py_tetris/` — the package:
  ...
  - `game.py` — board helpers (`collides`, `place_piece`, `evaluate_board`, `rest_y`), `Game`, `evaluate_placement`, `Bot` (pure logic, no pygame)
